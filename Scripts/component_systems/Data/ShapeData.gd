...
func expand_xy_dimensions(shape_component: ShapeComponent, amount: float) -> Dictionary:
...
func expand_z_dimension(shape_component: ShapeComponent, amount: float) -> Dictionary:
	var shape_type = shape_component.shape_type
	var args = shape_component.shape_args
